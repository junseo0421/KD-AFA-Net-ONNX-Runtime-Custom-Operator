...
If the versions do not match, an API version mismatch error may occur.

The requested API version [25] is not available,
...
<PROJECT_ROOT>
├─ analysis
│  └─ processing_time_onnx_customop.py
│
├─ models
│  └─ unet
│     ├─ sep_unet_model_custom.py
│     ├─ sep_unet_parts.py
│     └─ sep_unet_parts_onnx.py
│
├─ custom_ops
│  ├─ kdafa_ort
│  │  ├─ CMakeLists.txt
...
ONNXRuntime-CPU-Custom average: about 43 ms
ONNXRuntime-GPU-Hybrid average: about 42 ms
...
[ONNXRuntime-CUDA-Custom] average (after warm=5): 5.972 ms
FPS: 168.45
